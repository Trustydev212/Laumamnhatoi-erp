...
@Module({
  ...
  controllers: [PrinterController, EnhancedPrinterController, XprinterReceiptController, ReceiptConfigController, HtmlReceiptController],
  providers: [PrinterService, EnhancedPrinterService, XprinterReceiptService, ReceiptConfigService, HtmlReceiptService, BankQRService, TaxConfigService],
  exports: [PrinterService, EnhancedPrinterService, XprinterReceiptService, ReceiptConfigService, HtmlReceiptService, BankQRService, TaxConfigService]
})
